        ...
        <noscript>
          <div style={{ padding: "40px", maxWidth: "800px", margin: "0 auto", fontFamily: "sans-serif", color: "#1a1a1a" }}>
            ...
            <ul>
              ...
              <li><a href="/Portfolio/projects/growth-automation">Growth Marketing and Content Automation: n8n Content Pipeline, Video Formula and Guideline-Verified E-Books</a></li>
